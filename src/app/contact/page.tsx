              ...
              <div style={{ background: "#fff", padding: "32px", borderRadius: "14px", border: "1px solid rgba(18,54,83,0.08)", boxShadow: "0 4px 20px rgba(18,54,83,0.04)" }}>
                ...
                <div style={{ display: "flex", gap: "16px", marginBottom: "1.5rem" }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: "14px", color: "var(--text)" }}>
                      Reception: <a href="tel:01722610806" style={{ color: "var(--navy)", fontWeight: 600 }}>0172-2610806</a>
                    </div>
                    <div style={{ fontSize: "14px", color: "var(--text)", marginTop: "2px" }}>
                      WhatsApp Helpline: <a href="https://wa.me/919988004806" target="_blank" rel="noopener noreferrer" style={{ color: "var(--navy)", fontWeight: 600 }}>+91 9988004806</a>
                    </div>
                  </div>
                </div>
                ...
                <div style={{ display: "flex", gap: "16px" }}>
                  ...
                  <div>
                    ...
                    <a href="mailto:rattananav@gmail.com" style={{ fontSize: "14px", color: "var(--navy)", fontWeight: 600, textDecoration: "none" }}>
              ...
              <div style={{ background: "#fff", padding: "32px", borderRadius: "14px", border: "1px solid rgba(18,54,83,0.08)", boxShadow: "0 4px 20px rgba(18,54,83,0.04)" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "10px", fontSize: "14px" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", paddingBottom: "8px", borderBottom: "1px solid rgba(18,54,83,0.06)" }}>
                    <span style={{ color: "var(--text)" }}>Morning (Mon – Sat):</span>
                    <strong style={{ color: "var(--navy)" }}>10:00 AM – 2:00 PM</strong>
                  </div>
                  <div style={{ display: "flex", justifyContent: "space-between", paddingBottom: "8px", borderBottom: "1px solid rgba(18,54,83,0.06)" }}>
                    <span style={{ color: "var(--text)" }}>Evening (Mon – Sat):</span>
                    <strong style={{ color: "var(--navy)" }}>5:30 PM – 8:00 PM</strong>
                  </div>
                  <div style={{ display: "flex", justifyContent: "space-between" }}>
                    <span style={{ color: "var(--text)" }}>Sunday Consultation:</span>
                    <strong style={{ color: "var(--gold)" }}>11:00 AM – 1:00 PM</strong>
                  </div>
                </div>
              </div>
              ...
              {submitted ? (
                <div style={{ textAlign: "center", padding: "40px 20px" }}>
                  ...
                  <div style={{ display: "flex", gap: "12px", justifyContent: "center", flexWrap: "wrap" }}>
                    <a
                      href={`https://wa.me/919988004806?text=${encodeURIComponent(`Hello Dr. Rattan ENT Clinic, I sent a message regarding: ${formData.subject}. My name is ${formData.name}.`)}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="btn-gold"
