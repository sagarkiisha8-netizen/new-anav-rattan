...
export default function HomeContent({ initialContent }: { initialContent?: SiteContent | null }) {
  ...
  return (
    <main>
      {/* HERO SECTION */}
      <section style={{
        minHeight: hasHeroImage ? "640px" : "auto",
        display: "flex",
        alignItems: "center",
        ...
        position: "relative",
        overflow: "hidden",
        padding: hasHeroImage ? "3.5rem 0" : "5rem 0 4.5rem"
      }}>
        ...
        <div style={{ maxWidth: hasHeroImage ? "1240px" : "960px", margin: "0 auto", padding: "0 2rem", width: "100%", position: "relative", zIndex: 2 }}>
          <div ref={heroRef} className={hasHeroImage ? "hero-two-col hero-with-image reveal" : "hero-two-col hero-text-only reveal"}>
            ...
            <div className="hero-left">
              ...
              <p style={{ fontSize: "15.5px", color: "rgba(255,255,255,0.8)", maxWidth: hasHeroImage ? "520px" : "720px", lineHeight: 1.75, marginBottom: "2rem" }}>
                {heroDescription}
              </p>
